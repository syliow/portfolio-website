...
const CardButtons = ({ svn_url }) => {
  //define a switch case for different svn_url
  console.log(svn_url);
  let demo_url;

  if (svn_url === "https://github.com/syliow/pengin-nft-website") {
    ...
    demo_url = "https://crypto-price-tracker-backend.herokuapp.com/";
  } else {
    svn_url = { svn_url };
  }
  ...
  return (
    <>
      ...
      >
        <i className="fab fa-github" /> Open Demo
      </a>
